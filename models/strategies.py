...
if __name__ == '__main__':
    ...
    strategies = [sixtyforty, onlystocks, vanillariskparity]
    for tr_strategy in strategies:
        ...
        cerebro.addstrategy(tr_strategy, printlog=False)

        # Print out the starting conditions
        result = cerebro.run()  # run it all
        figure = cerebro.plot(iplot=False)[0][0]
        figure.savefig('Test strategy %s.png' % tr_strategy.strategy_name)
